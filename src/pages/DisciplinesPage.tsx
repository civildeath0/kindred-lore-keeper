    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-8">
          ...
          <h1 className="page-title mb-0 pb-0 border-0">{t('disciplinesTitle')}</h1>
        </div>
          ...
          <div className="space-y-10">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="hidden md:flex h-12 w-12 rounded-full bg-gradient-to-br from-vampire-primary/20 to-vampire-blood/30 items-center justify-center flex-shrink-0 mt-1">
                    <Droplet className="text-vampire-primary" size={20} />
                  </div>
            ...
            {pages.length === 0 && (
              <div className="content-section p-8">
                <p className="text-center text-vampire-text/80 text-lg">No discipline pages found.</p>
              </div>
            )}
          </div>
        )}
